...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    await queryInterface.bulkInsert('Logout', [
      {
        user_id: 1,
        timestamp: new Date(),
      },
   ...
   await queryInterface.bulkInsert('Proyek', [
    {
      nama: 'Proyek A',
    ...
    await queryInterface.bulkInsert('Komentar', [
      {
        user_id: 1,
        proyek_id: 1,
  ...
  down: async (queryInterface, Sequelize) => {
    ...
    // Hapus semua data dari tabel Anggotas
